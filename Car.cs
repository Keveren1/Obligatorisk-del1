...
namespace Opgave_1_kode_og_unit_test
{
    public class Car
    {
        ...
        public string Model
        {
            ...
            set
            {
                if (value.Length < 4) throw new ArgumentOutOfRangeException("Du skal skrive mere end 3 tegn");
        ...
        public string LicensePlate
        {
            ...
            set
            {
                if (value.Length < 2 || value.Length > 7) throw new ArgumentOutOfRangeException("Angiv venligst en gyldig nummerplade");
